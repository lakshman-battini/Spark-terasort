...
# Class Name
TERAGEN_CLASS_NAME="com.nexr.spark.terasort.TeraGen"
TERASORT_CLASS_NAME="com.nexr.spark.terasort.TeraSort"
TERAVAL_CLASS_NAME="com.nexr.spark.terasort.TeraValidate"
